      ...
      <div className="glass p-8 text-center">
        ...
        <div className="glass p-4 mb-6 text-left text-sm">
          ...
          <ul className="text-white/40 space-y-1 text-xs">
            <li>• host picks players per position (1 option per non-host player)</li>
            <li>• wheel spins to decide which position + option gets auctioned</li>
            <li>• everyone bids, 15s countdown resets after each bid</li>
